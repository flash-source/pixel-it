...
const pixels = [
  ['#6c63ff','#4a3f99','#6c63ff','#9b8cff','#6c63ff'],
  ['#4a3f99','#6c63ff','#9b8cff','#6c63ff','#4a3f99'],
  ['#9b8cff','#6c63ff','#4a3f99','#6c63ff','#9b8cff'],
  ['#6c63ff','#9b8cff','#6c63ff','#4a3f99','#6c63ff'],
  ['#4a3f99','#6c63ff','#9b8cff','#6c63ff','#4a3f99'],
]
  ...
  return (
    <div className="min-h-screen bg-[#07070d] flex">
      ...
      <div className="hidden lg:flex flex-col w-[45%] bg-[#0a0a14] border-r border-white/[0.06] p-14 relative overflow-hidden">
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_left,rgba(108,99,255,0.18),transparent_55%)] pointer-events-none" />
        ...
        <p style={{ fontFamily: "'JetBrains Mono', monospace" }}
          className="relative z-10 text-[10px] text-white/15">
        ...
        <div className="w-full max-w-md">
          <div className="mb-10">
            ...
            <p style={{ fontFamily: "'JetBrains Mono', monospace" }}
              ...
              <Link href="/register" className="text-[#6c63ff] hover:text-[#9b8cff] transition-colors">
                create one
              </Link>
            </p>
          </div>
